...
void help(){
    ...
    printf("HELP\n");
    printf("-------------------------------------\n");
    printf("1. type 'play' for Play song\n");
    printf("2. type 'pause' for Pause song\n");
    printf("3. type 'next' for Next song\n");
    printf("4. type 'prev' for Previous song\n");
    printf("5. type 'choose' for Choose Song\n");
    printf("6. type 'list' for List of Song\n");
    printf("7. type 'help' for Help\n");
}
